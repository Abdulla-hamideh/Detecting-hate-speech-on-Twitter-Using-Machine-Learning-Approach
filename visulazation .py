...
wordcloud = WordCloud(max_font_size = 110,background_color="black",colormap="Reds").generate(hate_words)
plt.axis('off')
...
wordcloud = WordCloud(max_font_size = 110,background_color="black",colormap="Reds").generate(off_words)
plt.axis('off')
plt.imshow(wordcloud, interpolation = 'bilinear',cmap='viridis')
plt.show()
...
wordcloud = WordCloud(max_font_size = 110,background_color="black",colormap="Reds").generate(normal_words)
plt.axis('off')
plt.imshow(wordcloud, interpolation = 'bilinear',cmap='viridis')
plt.show()
...
print(modified_data.head(10).to_string())
